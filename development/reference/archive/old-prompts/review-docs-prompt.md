...
- Before major milestones (pre-launch, pre-deployment)
- When onboarding new contributors
- Quarterly or monthly checkups
- When documentation feels insufficient
...
**Critical Issue:**
> KNOWN_ISSUES.md lists ImageOptimization as a blocker, but this was fixed 2 weeks ago according to git history. This could mislead stakeholders about deployment readiness.

**Recommendation:**
> Remove fixed issue from KNOWN_ISSUES.md and document the fix in PRD.md progress log.

**Gap:**
> DECISIONS.md doesn't explain why we chose Tailwind over CSS Modules. This decision has been questioned multiple times and context would help.

**Recommendation:**
> Add section to DECISIONS.md explaining Tailwind choice, including trade-offs and when to reconsider.
...
2. Plan time for short-term improvements
3. Add long-term enhancements to backlog
4. Schedule next review
5. Update docs based on findings

**Remember:**
- Documentation debt compounds like technical debt
- Better to fix now than let it rot
- Good docs save hours of explanation later

...
echo "==============================================================="
echo "  NEXT: Restart Claude Code and complete the migration"
echo "==============================================================="
echo ""
...
echo ""
echo "---"
echo "Complete the v6.0 migration. Read any old context files that exist,"
echo "extract valuable information, create/update v6.0 files, then delete the old files."
echo ""
echo "STEP 1: Read old files (if they exist):"
echo "  - context/SESSIONS.md (session history)"
echo "  - context/CONTEXT.md (project context)"
echo "  - context/STATUS.md (old format)"
echo "  - context/DECISIONS.md (old format)"
echo ""
echo "STEP 2: Create/update context/STATUS.md with this format:"
echo "  # Status"
echo "  SchemaVersion: 1"
echo "  LastUpdated: YYYY-MM-DD"
echo "  HeadCommit: [git SHA or N/A]"
echo "  Objective: [from old files or ask me]"
echo "  ## Working Set"
echo "  - [3-7 files currently being worked on]"
echo "  ## Next Actions"
echo "  - [concrete next steps]"
echo "  ## Blocked On"
echo "  - (None)"
echo ""
echo "STEP 3: Create/update context/DECISIONS.md with this format:"
echo "  # Decisions"
echo "  Append-only log."
echo "  ---"
echo "  ## YYYY-MM-DD: [Area] Decision Title"
echo "  Why: [reason]"
echo "  Tradeoff: [what we gave up]"
echo "  RevisitWhen: [trigger to revisit]"
echo "  (Preserve any existing decisions, reformatting to this structure)"
echo ""
echo "STEP 4: Check CLAUDE.md has the Session Loop block at the top:"
echo "  > **Session Loop**"
echo "  > 1. Start -> Read context/STATUS.md"
echo "  > 2. End -> Run /save"
echo "  If missing, add it. This is how future sessions know to use the context system."
echo ""
echo "STEP 5: Delete old files:"
echo "  rm context/SESSIONS.md context/CONTEXT.md (if they exist)"
echo ""
echo "STEP 6: Verify with /save"
echo "---"
echo ""
echo "==============================================================="
